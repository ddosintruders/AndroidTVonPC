...
2. If you want remote control, download [Bluetooth Remote](https://play.google.com/store/apps/details?id=com.app.bluetoothremote&hl=en-US&pli=1) from Google Play Store on your Android Phone, pair it with your custom Google/Android TV. You need a BLE-Supported Phone (most phones have it nowadays), or buy a Bluetooth Remote if you do not prefer using your phone. Your computer/laptop must have Bluetooth functionality to be able to use Bluetooth Remote. If not, purchase a USB Bluetooth Dongle.
3.  If you need Android TV installed directly on your harddisk, be prepared. You won't utilise the full storage if you have 256GB or more. Best to stick with a USB Flah Drive or an external SSD until a solution to Note 1 is developed.
